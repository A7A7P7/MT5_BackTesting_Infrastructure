...
class ADX:
    ...
    def __init__(self,atr_class:ATR):
...
class MACD:
    ...
    def __init__(self,lower_period_ema:EMA,higher_period_ema:EMA,ema_periods_difference_line:int):
...
class Bollinger_Bands:
    ...
    def __init__(self,middle_band:SMA,distance_from_middle_in_st_devs:int):
...
class Stochastic_Oscillator:
    ...
    def __init__(self,n_periods_used:int,n_periods_for_slow_stochastic:int):
...
class GraphicHelpers:
    ...
    def lst_balances_to_candle(self,lst_disp_balance:list,lst_unrealized_balance:list,lst_equity_curve:list):
    ...
    def histogram_of_returns(self,lst_disp_balance:list,lst_unrealized_balance:list,lst_equity_curve:list):
        ...
        unrealized_balance = df_balances["Unrealized_Balance"]
        returns = unrealized_balance.pct_change()
