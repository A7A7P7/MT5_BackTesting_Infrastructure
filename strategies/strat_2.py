...
"""KEYS OF 'structure_snapshot'

'current_candle' - a dict with the following keys:
    - 'current_candle_ts'
    - 'current_candle_open'
    - 'current_candle_high'
    - 'current_candle_low'
    - 'current_candle_close'
    - 'current_candle_tick_vol'
...
class H1_Strat_Signal: #NO INIT NO MEMORY, PURE STATELESS DOESN'T HAVE ANY PROPERTIES, IT DEPENDS ON PROPERTIES YOU GIVE TO YOUR INDICATORS 
